...
# due to overly stringent p-value adjustment, some differences arent' signficant. However, there are noticeable effects
...
mod_one_epn <- lmerTest::lmer(EPN ~ block + lateralization + (1|pid), data = per_erp_filter_lat  %>% filter(lateralization %in% c("left", "right")))
# check assumptions
