...
assumption_plots(block_mod_lpp)
performance::check_model(block_mod_lpp, panel = FALSE)
summary(block_mod)
# contrasts
emm_LPP <- emmeans(block_mod, pairwise ~ lateralization | block)
...
summary(block_mod_filter)
performance::check_model(block_mod_lpp_filter, panel = FALSE)
# contrasts
emm_LPP_filter <- emmeans(block_mod_filter, pairwise ~ lateralization | block)
...
# contrasts
emm_EPN <- emmeans(block_mod_epn, pairwise ~ lateralization | block)
...
# contrasts
emm_EPN_filter <- emmeans(block_mod_epn_filter, pairwise ~ lateralization | block)
