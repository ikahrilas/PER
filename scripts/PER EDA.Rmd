...
lpp_elec <- c("A25", "B28", "B22") # look at 425-1000 and 1000-2000 ms windows
...
per_erp %>% 
  ...
  summarize(LPP_mean = mean(LPP, na.rm = TRUE),
            ...
            LPP_late_sd = mean(LPP_late, na.rm = TRUE),
            ...
            front_right_mean = mean(front_right, na.rm = TRUE),
            front_right_sd = sd(front_right, na.rm = TRUE),
            front_left_mean = mean(front_left, na.rm = TRUE),
            front_left_sd = sd(front_left, na.rm = TRUE))
```
