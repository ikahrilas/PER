...
The relationship between these variables doesn't appear to be 
...
mod <- lm(LPP ~ savoring_moment, data = per_erp_int)
mod_2 <- lm(LPP ~ poly(savoring_moment, 3), data = per_erp_int)
