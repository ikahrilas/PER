...
per_erp_int_rem %>% 
  ...
  geom_point() + 
  geom_smooth(method = "lm") +
  ggtitle("Positive affectivity and LPP in positive watch condition w/out outliers")
```
...
per_erp_int_rem %>% 
  ...
  geom_point() + 
  geom_smooth(method = "lm") +
  ggtitle("Savoring the moment and LPP in the positive increase condition w/out outliers")
```
...
Scatterplot between LPP and dificulty ratings. Please note that the two scatterplots appear different since random noise was added to each data point to prevent overplotting.
